...
#
# QwenWorkCN note: the DMG wraps the bundle in a top-level directory named
# "<display-name> Installer" (e.g. "千问办公 Installer/QwenWorkCN.app"), so the
# .app search must descend a few levels (see resolve_app_bundle below).
...
resolve_app_bundle() {
    ...
    # QwenWorkCN nests the bundle one level deeper than WorkBuddy
    # ("千问办公 Installer/QwenWorkCN.app"); maxdepth 5 covers it.
